        ...
        <tr>
            <td bgcolor="#FAFAFA">
                ...
                <p>In cima ad ogni pagina viene mostrato un messaggio di benvenuto e la data odierna.
                    ...
                    &quot;Esci&quot; per rimuovere eventuali cookie residui ed <a href="#logging_in">autenticarsi</a>
                    con le
                    proprie credenziali.
                ...
                <p>L'autenticazione avviene tramite login e password. Il login pu&ograve;
                    ...
                    pi&ugrave; login e password. <i>Utilizzare questa opzione solo se la postazione non &egrave;
                        condivisa con altri utenti!</i><br>Dopo l'autenticazione appare la <a href="#message_summary">pagina
                        principale</a>.</p>
                <p class="alignright"><a href="#top">Torna su</a></p>
