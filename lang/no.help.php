...
<div align="center"> 
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="5" style="border: solid #CCCCCC 1px">
    <tr> 
      <td bgcolor="#FAFAFA"> 
        <ul>
          <li><b><a href="#getting_started">Kom i gang</a></b></li>
          <ul>
            <li><a href="#logging_in">Logge inn</a></li>
            <li><a href="#language">Velg mitt spr&aring;k</a></li>
            <li><a href="#getting_support">F&aring; hjelp</a></li>
          </ul>
          <li><a href="#using_mailzu"><b>Hvordan bruke MailZu</b></a></li>
          <ul>
        ...
        <p> &Oslash;verst p&aring; hver side ser du en velkomstmelding og dagens dato.
          ...
          Av&quot; for &aring; fjerne eventuelle cookies de brukte og <a href="#logging_in">Logg
          Inn</a> som deg selv.
          Klikk p&aring; &quot;Hjelp&quot; lenken for &aring; vise dette popup-hjelpevinduet. Klikker en p&aring;
          "E-postadministrator" lenken vil det &aring;pne en ny e-post adressert til systemets administrator.</p>
        ...
        <p> For &aring; logge inn, m&aring; brukerne oppgi brukernavn og passord. Brukernavn
          ...
          behovet for &aring; logge inn hver gang. <i> Du b&oslash;r bare bruke dette alternativet hvis
