    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="5" style="border: solid #CCCCCC 1px">
        <tr>
            <td bgcolor="#FAFAFA">
                ...
                <p class="alignright"><a href="#top">Zum Anfang</a></p>
                ...
                <p> Um einloggen zu können, benötigen Sie einen Benutzernamen und Passwort.
                    ...
                    wird bei Ihnen ein Cookie gespeichert, damit Sie sich in Zukunft nicht mehr manuell einloggen
                    müssen.
                    <i>Benutzen Sie diese Option nur, wenn Sie der einzige Benutzer an dieser Arbeitsstation
                        sind!</i> Nach erfolgreichem einloggen, gelangen Sie zur <a href="#msg_summary">Nachrichten
                        Übersicht</a>.</p>
                ...
                <p>Sie haben nun mehrere Möglichkeiten, was sie mit den Nachrichten machen wollen.
                    'Freigabe anfordern' sendet eine Anfrage an Ihren Administrator oder falls diese Option nicht
                    eingesetzt
                    wird, sendet das System die Nachricht direkt an Sie weiter. Um Nachrichten zu 'löschen', können Sie
                    einzelne
                    Nachrichten mittels der Checkbox rechts anwählen oder 'Alle Nachrichten löschen'.</p>
                <p>Wenn sie Ihre offenen Anfragen einsehen, können sie diese auch löschen indem Sie auf 'Anfrage
                    abbrechen'
                    klicken.</p>
                <p class="alignright"><a href="#top">Zum Anfang</a></p>
                <h5><a name="search" id="search"></a>Nachricht suchen</h5>
                <p>Um schnell eine Nachricht zu finden, benutzen Sie die Suchfunktion.
                    Sie können nach einem Absender, Betreff oder nach beidem suchen. Gross/Kleinschreibung wird nicht
                    beachtet.</p>
                <p class="alignright"><a href="#top">Zum Anfang</a></p>
                <h5><a name="msg_view" id="msg_view"></a>Nachricht anzeigen</h5>
                <p>Sie haben die Erlaubnis, ihre Emails einzusehen um deren Inhalt festzustellen. Mit den Optionen das
                    Mail in
                    Textform und weitere Headerinformationen anzeigen zulassen, sollten Sie in der Lage sein zu
                    entscheiden, ob Sie
